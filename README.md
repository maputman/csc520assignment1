...
DFS: <br>
Test 1: <br>
In the "Harry" sprite, scroll to the bottom of the Scripts tab. There is a small block of code that begins with "when green flag clicked." Input "Great Hall" into the first text input and input "DFS" into the second text input. <br>

Test 2: <br>
In the "Harry" sprite, scroll to the bottom of the Scripts tab. There is a small block of code that begins with "when green flag clicked." Input "Dungeons" into the first text input and input "DFS" into the second text input. <br>

Test 3: <br>
In the "Harry" sprite, scroll to the bottom of the Scripts tab. There is a small block of code that begins with "when green flag clicked." Input "Long Corridor" into the first text input and input "DFS" into the second text input. <br>
